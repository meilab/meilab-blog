...
export class MessageList extends Component {
  ...
  render() {
    return (
      ...
      >
        <div ref={this.loadRef} onScroll={this.onScroll} className="rce-mlist">
          {this.props.dataSource.map((x, i) => (
            <MessageBox
              ...
              onForwardClick={
                ...
                ((e) => this.onForwardClick(x, i, e))
              }
              onReplyClick={
                this.props.onReplyClick && ((e) => this.onReplyClick(x, i, e))
              }
              onReplyMessageClick={
                this.props.onReplyMessageClick &&
                ((e) => this.onReplyMessageClick(x, i, e))
              }
